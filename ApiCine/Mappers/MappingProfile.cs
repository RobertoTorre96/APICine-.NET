    ...
    public class MappingProfile : Profile {
        public MappingProfile() {
            ...
            CreateMap<SalaEntity, SalaResponseDto>()
             .ForMember(dest => dest.CantidadFilas, opt => opt.MapFrom(src =>
                 (src.Asientos != null && src.Asientos.Any())
                 ? src.Asientos.Max(a => Convert.ToInt32(a.Fila))
                 : 0))
             .ForMember(dest => dest.CantidadColumnas, opt => opt.MapFrom(src =>
                 (src.Asientos != null && src.Asientos.Any())
                 ? src.Asientos.Max(a => Convert.ToInt32(a.Numero))
                 : 0));
            ...
            CreateMap<FuncionEntity, FuncionResponseDetalleDto>()
                ...
                // Datos de Sala (Usamos la lógica de máximo que aprendimos antes)
                .ForMember(dest => dest.SalaNombre, opt => opt.MapFrom(src => src.Sala.Nombre))
                .ForMember(dest => dest.CantidadFilas, opt => opt.MapFrom(src =>
                    (src.Sala.Asientos != null && src.Sala.Asientos.Any()) ? src.Sala.Asientos.Max(a => Convert.ToInt32(a.Fila)) : 0))
                .ForMember(dest => dest.CantidadColumnas, opt => opt.MapFrom(src =>
                    (src.Sala.Asientos != null && src.Sala.Asientos.Any()) ? src.Sala.Asientos.Max(a => Convert.ToInt32(a.Numero)) : 0))
